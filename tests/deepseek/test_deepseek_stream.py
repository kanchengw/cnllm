...
class TestDeepSeekStreamBasic:
    ...
    def test_stream_basic(self, responder):
        ...
        for i, raw_chunk in enumerate(raw_chunks):
            chunk = responder.to_openai_stream_format(raw_chunk, "deepseek-chat")
            chunks.append(chunk)
...
class TestDeepSeekStreamThinking:
    ...
    def test_stream_thinking(self, responder):
        ...
        for i, raw_chunk in enumerate(raw_chunks):
            chunk = responder.to_openai_stream_format(raw_chunk, "deepseek-reasoner")
            chunks.append(chunk)
