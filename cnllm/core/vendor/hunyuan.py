...
class HunyuanVendorError(VendorError):
    VENDOR_NAME = "hunyuan"

    @classmethod
    def from_response(cls, raw_response: dict) -> Optional["HunyuanVendorError"]:
        if not raw_response:
            return None
...
VendorErrorRegistry.register("hunyuan", HunyuanVendorError)


class HunyuanResponder(Responder):
    CONFIG_DIR = "hunyuan"


class HunyuanAdapter(BaseAdapter):
    ADAPTER_NAME = "hunyuan"
    CONFIG_DIR = "hunyuan"
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.responder = HunyuanResponder()
